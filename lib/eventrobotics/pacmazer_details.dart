...
class PacmazerDetails extends StatefulWidget {

  final String name;
  final String rules;

  PacmazerDetails(this.name,this.rules);

  @override
  _PacmazerDetailsState createState() => _PacmazerDetailsState(this.name,this.rules);
}

class _PacmazerDetailsState extends State<PacmazerDetails> {

  final String name;
  final String rules;

  _PacmazerDetailsState(this.name,this.rules);
