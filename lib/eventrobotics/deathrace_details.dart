...
class DeathraceDetails extends StatefulWidget {

  final String name;
  final String rules;

  DeathraceDetails(this.name,this.rules);

  @override
  _DeathraceDetailsState createState() => _DeathraceDetailsState(this.name,this.rules);
}

class _DeathraceDetailsState extends State<DeathraceDetails> {

  final String name;
  final String rules;

  _DeathraceDetailsState(this.name,this.rules);
