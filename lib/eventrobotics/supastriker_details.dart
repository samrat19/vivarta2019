...
class SupastrikerDetails extends StatefulWidget {

  final String name;
  final String rules;

  SupastrikerDetails(this.name,this.rules);

  @override
  _SupastrikerDetailsState createState() => _SupastrikerDetailsState(this.name,this.rules);
}

class _SupastrikerDetailsState extends State<SupastrikerDetails> {

  final String name;
  final String rules;

  _SupastrikerDetailsState(this.name,this.rules);
