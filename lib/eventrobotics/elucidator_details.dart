...
class ElucidatorDetails extends StatefulWidget {

  final String name;
  final String rules;

  ElucidatorDetails(this.name,this.rules);

  @override
  _ElucidatorDetailsState createState() => _ElucidatorDetailsState(this.name,this.rules);
}

class _ElucidatorDetailsState extends State<ElucidatorDetails> {

  final String name;
  final String rules;

  _ElucidatorDetailsState(this.name,this.rules);
