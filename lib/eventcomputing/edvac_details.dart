...
class EdvacDetails extends StatefulWidget {

  final String name;
  final String rules;

  EdvacDetails(this.name,this.rules);

  @override
  _EdvacDetailsState createState() => _EdvacDetailsState(this.name,this.rules);
}

class _EdvacDetailsState extends State<EdvacDetails> {

  final String name;
  final String rules;

  _EdvacDetailsState(this.name,this.rules);

  final String url = "https://www.jasonbase.com/things/0BlG.json";
  List data;
