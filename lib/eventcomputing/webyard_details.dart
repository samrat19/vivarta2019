...
class WebDetails extends StatefulWidget {
  ...
  WebDetails(this.name,this.rules);

  @override
  _WebDetailsState createState() => _WebDetailsState(this.name,this.rules);
}
...
class _WebDetailsState extends State<WebDetails> {
  ...
  _WebDetailsState(this.name,this.rules);

  final String url = "https://www.jasonbase.com/things/Belp.json";
  List data;
