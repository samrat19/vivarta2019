...
class AndroDetails extends StatefulWidget {

  final String name;
  final String rules;

  AndroDetails(this.name,this.rules);

  @override
  _AndroDetailsState createState() => _AndroDetailsState(this.name,this.rules);
}

class _AndroDetailsState extends State<AndroDetails> {

  final String name;
  final String rules;

  _AndroDetailsState(this.name,this.rules);
