...
class CrossDetails extends StatefulWidget {

  final String name;
  final String rules;

  CrossDetails(this.name,this.rules);

  @override
  _CrossDetailsState createState() => _CrossDetailsState(this.name,this.rules);
}

class _CrossDetailsState extends State<CrossDetails> {

  final String name;
  final String rules;

  _CrossDetailsState(this.name,this.rules);

  final String url = "https://www.jasonbase.com/things/87ln.json";
  List data;
