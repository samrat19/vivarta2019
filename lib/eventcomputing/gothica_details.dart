...
class GothicaDetails extends StatefulWidget {

  final String name;
  final String rules;

  GothicaDetails(this.name,this.rules);

  @override
  _GothicaDetailsState createState() => _GothicaDetailsState(this.name,this.rules);
}

class _GothicaDetailsState extends State<GothicaDetails> {

  final String name;
  final String rules;

  _GothicaDetailsState(this.name,this.rules);

  final String url = "https://www.jasonbase.com/things/R4pJ.json";
  List data;
