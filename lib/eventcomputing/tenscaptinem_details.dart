...
class TensDetails extends StatefulWidget {

  final String name;
  final String rules;

  TensDetails(this.name,this.rules);

  @override
  _TensDetailsState createState() => _TensDetailsState(this.name,this.rules);
}

class _TensDetailsState extends State<TensDetails> {

  final String name;
  final String rules;

  _TensDetailsState(this.name,this.rules);

  final String url = "https://www.jasonbase.com/things/Jzl5.json";
  List data;
