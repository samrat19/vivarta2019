...
class BattleroyaleDetails extends StatefulWidget {

  final String name;
  final String rules;

  BattleroyaleDetails(this.name,this.rules);

  @override
  _BattleroyaleDetailsState createState() => _BattleroyaleDetailsState(this.name,this.rules);
}

class _BattleroyaleDetailsState extends State<BattleroyaleDetails> {

  final String name;
  final String rules;

  _BattleroyaleDetailsState(this.name,this.rules);
