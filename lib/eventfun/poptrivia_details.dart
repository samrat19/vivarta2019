...
class PoptriviaDetails extends StatefulWidget {

  final String name;
  final String rules;

  PoptriviaDetails(this.name,this.rules);

  @override
  _PoptriviaDetailsState createState() => _PoptriviaDetailsState(this.name,this.rules);
}

class _PoptriviaDetailsState extends State<PoptriviaDetails> {

  final String name;
  final String rules;

  _PoptriviaDetailsState(this.name,this.rules);
