...
class BodyzorbingDetails extends StatefulWidget {

  final String name;
  final String rules;

  BodyzorbingDetails(this.name,this.rules);

  @override
  _BodyzorbingDetailsState createState() => _BodyzorbingDetailsState(this.name,this.rules);
}

class _BodyzorbingDetailsState extends State<BodyzorbingDetails> {

  final String name;
  final String rules;

  _BodyzorbingDetailsState(this.name,this.rules);
