...
class SnapitallDetails extends StatefulWidget {

  final String name;
  final String rules;

  SnapitallDetails(this.name,this.rules);

  @override
  _SnapitallDetailsState createState() => _SnapitallDetailsState(this.name,this.rules);
}

class _SnapitallDetailsState extends State<SnapitallDetails> {

  final String name;
  final String rules;

  _SnapitallDetailsState(this.name,this.rules);
