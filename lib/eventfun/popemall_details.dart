...
class PopemallDetails extends StatefulWidget {

  final String name;
  final String rules;

  PopemallDetails(this.name,this.rules);

  @override
  _PopemallDetailsState createState() => _PopemallDetailsState(this.name,this.rules);
}

class _PopemallDetailsState extends State<PopemallDetails> {

  final String name;
  final String rules;

  _PopemallDetailsState(this.name,this.rules);
