...
class QuestivalDetails extends StatefulWidget {

  final String name;
  final String rules;

  QuestivalDetails(this.name,this.rules);

  @override
  _QuestivalDetailsState createState() => _QuestivalDetailsState(this.name,this.rules);
}

class _QuestivalDetailsState extends State<QuestivalDetails> {

  final String name;
  final String rules;

  _QuestivalDetailsState(this.name,this.rules);
