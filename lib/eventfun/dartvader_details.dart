...
class DartvaderDetails extends StatefulWidget {

  final String name;
  final String rules;

  DartvaderDetails(this.name,this.rules);

  @override
  _DartvaderDetailsState createState() => _DartvaderDetailsState(this.name,this.rules);
}

class _DartvaderDetailsState extends State<DartvaderDetails> {

  final String name;
  final String rules;

  _DartvaderDetailsState(this.name,this.rules);
