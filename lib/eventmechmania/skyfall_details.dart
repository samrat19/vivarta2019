...
class SkyfallDetails extends StatefulWidget {

  final String name;
  final String rules;

  SkyfallDetails(this.name,this.rules);

  @override
  _SkyfallDetailsState createState() => _SkyfallDetailsState(this.name,this.rules);
}

class _SkyfallDetailsState extends State<SkyfallDetails> {

  final String name;
  final String rules;

  _SkyfallDetailsState(this.name,this.rules);
