...
class PoseidonDetails extends StatefulWidget {

  final String name;
  final String rules;

  PoseidonDetails(this.name,this.rules);

  @override
  _PoseidonDetailsState createState() => _PoseidonDetailsState(this.name,this.rules);
}

class _PoseidonDetailsState extends State<PoseidonDetails> {

  final String name;
  final String rules;

  _PoseidonDetailsState(this.name,this.rules);
