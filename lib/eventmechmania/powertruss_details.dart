...
class PowertrussDetails extends StatefulWidget {

  final String name;
  final String rules;

  PowertrussDetails(this.name,this.rules);

  @override
  _PowertrussDetailsState createState() => _PowertrussDetailsState(this.name,this.rules);
}

class _PowertrussDetailsState extends State<PowertrussDetails> {

  final String name;
  final String rules;

  _PowertrussDetailsState(this.name,this.rules);
