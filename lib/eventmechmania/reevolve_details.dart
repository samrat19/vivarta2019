...
class ReevolveDetails extends StatefulWidget {

  final String name;
  final String rules;

  ReevolveDetails(this.name,this.rules);

  @override
  _ReevolveDetailsState createState() => _ReevolveDetailsState(this.name,this.rules);
}

class _ReevolveDetailsState extends State<ReevolveDetails> {

  final String name;
  final String rules;

  _ReevolveDetailsState(this.name,this.rules);
