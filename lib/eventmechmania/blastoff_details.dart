...
class BlastoffDetails extends StatefulWidget {

  final String name;
  final String rules;

  BlastoffDetails(this.name,this.rules);

  @override
  _BlastoffDetailsState createState() => _BlastoffDetailsState(this.name,this.rules);
}

class _BlastoffDetailsState extends State<BlastoffDetails> {

  final String name;
  final String rules;

  _BlastoffDetailsState(this.name,this.rules);
