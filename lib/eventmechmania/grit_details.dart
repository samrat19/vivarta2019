...
class GritDetails extends StatefulWidget {

  final String name;
  final String rules;

  GritDetails(this.name,this.rules);

  @override
  _GritDetailsState createState() => _GritDetailsState(this.name,this.rules);
}

class _GritDetailsState extends State<GritDetails> {

  final String name;
  final String rules;

  _GritDetailsState(this.name,this.rules);
