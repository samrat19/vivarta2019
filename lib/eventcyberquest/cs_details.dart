...
class CsDetails extends StatefulWidget {

  final String name;
  final String rules;

  CsDetails(this.name,this.rules);

  @override
  _CsDetailsState createState() => _CsDetailsState(this.name,this.rules);
}

class _CsDetailsState extends State<CsDetails> {

  final String name;
  final String rules;

  _CsDetailsState(this.name,this.rules);
