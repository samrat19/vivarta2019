...
class TekkenDetails extends StatefulWidget {

  final String name;
  final String rules;

  TekkenDetails(this.name,this.rules);

  @override
  _TekkenDetailsState createState() => _TekkenDetailsState(this.name,this.rules);
}

class _TekkenDetailsState extends State<TekkenDetails> {

  final String name;
  final String rules;

  _TekkenDetailsState(this.name,this.rules);
