...
class DotaDetails extends StatefulWidget {

  final String name;
  final String rules;

  DotaDetails(this.name,this.rules);

  @override
  _DotaDetailsState createState() => _DotaDetailsState(this.name,this.rules);
}

class _DotaDetailsState extends State<DotaDetails> {

  final String name;
  final String rules;

  _DotaDetailsState(this.name,this.rules);
