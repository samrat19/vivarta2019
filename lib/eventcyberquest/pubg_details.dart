...
class PubgDetails extends StatefulWidget {

  final String name;
  final String rules;

  PubgDetails(this.name,this.rules);

  @override
  _PubgDetailsState createState() => _PubgDetailsState(this.name,this.rules);
}

class _PubgDetailsState extends State<PubgDetails> {

  final String name;
  final String rules;

  _PubgDetailsState(this.name,this.rules);
